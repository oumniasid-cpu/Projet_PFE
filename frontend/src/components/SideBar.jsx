...
// Import your logo/icon asset if needed
...
const SideBar = () => {
  ...
  return (
    <aside className="w-64 h-screen bg-[#0D1B3E] flex flex-col p-4 shadow-xl">
      {/* Header with Logo and Collapse Icon */}
      <div className="flex items-center justify-between mb-10 px-2">
        <div className="bg-[#1d37c8] p-1.5 rounded-lg shadow-inner">
